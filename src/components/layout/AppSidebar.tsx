...
const baseNavItems: NavItem[] = [
  ...
  { to: "/scan-investigations", icon: AlertTriangle, label: "Scan Investigations", minRole: ["admin", "supervisor"] },
  { to: "/reports", icon: FileText, label: "Reports", minRole: ["admin", "supervisor"] },
  { to: "/reports/checkpoint-activity", icon: ListChecks, label: "Checkpoint Reports", minRole: ["admin", "supervisor"] },
