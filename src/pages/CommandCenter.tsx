...
export default function CommandCenter() {
  ...
  useEffect(() => {
    if (!companyId) return;
    const tables = ["scan_logs", "alerts", "incidents", "devices", "checkpoints", "ai_reports", "report_jobs", "ai_insights", "cameras", "camera_events"];
