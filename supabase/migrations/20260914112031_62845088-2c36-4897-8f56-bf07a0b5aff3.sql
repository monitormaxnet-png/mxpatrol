...
revoke all on function public.submit_data_log_submission(uuid, jsonb, uuid) from public;
revoke all on function public.submit_data_log_submission(uuid, jsonb, uuid) from anon;
