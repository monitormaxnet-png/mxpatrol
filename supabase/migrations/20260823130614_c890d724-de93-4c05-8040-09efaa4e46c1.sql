...
alter table public.devices drop constraint if exists devices_secure_mode_status_check;
...
grant all on public.device_request_nonces to service_role;
grant select, insert, update, delete on public.device_security_events to authenticated;
grant all on public.device_security_events to service_role;
